...
public record House(
    ...
    string Category,
    [property: JsonPropertyName("world")]
    World World,
...
public record World(
    [property: JsonPropertyName("floors")]
    IEnumerable<FloorsItem> Floors,
    [property: JsonPropertyName("walls")]
    IEnumerable<WallsItem> Walls
);
...
public record WallsItem(
    ...
    string Tls,
    [property: JsonPropertyName("trs")]
    string Trs,
    [property: JsonPropertyName("tlp")]
    string Tlp,
    [property: JsonPropertyName("trp")]
    string Trp,
    [property: JsonPropertyName("brp")]
    string Brp,
    [property: JsonPropertyName("blp")]
    string Blp
);
